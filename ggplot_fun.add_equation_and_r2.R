# check these pages for solutions
# https://mine-cetinkaya-rundel.github.io/r4ds-solutions/data-visualize.html
# https://github.com/nhs-r-community/r4ds-ed2-exercise-solutions
...
# solution to exeercise 8 pg 13
# using 3rd variable creates color window on side
ggplot(
  data = penguins,
